...
const ProjectCard: React.FC<ProjectCardProps> = ({ data }) => {
  return (
    <div className='min-w-[300px] max-w-[300px] min-h-[450px] sm:w-80 flex flex-col gap-4 border border-gray-500 p-4 rounded-xl'>
      <div>
